...
{      
  ...
  AL::ALModule::createModule<Logger>( pBroker, "ediLogger" );
...
int main( int argc, char *argv[] )
{
  ...
  // call main
  ALTools::mainFunction("ediLogger",argc, argv,sig);
}
#endif
